...
function generateProductHTML(product) {
  const whatsappLink = `https://wa.me/523347540496?text=${encodeURIComponent(product.whatsappMessage)}`;
...
<head>
  ...
  <meta name="keywords" content="${product.name}, ${product.categoryName}, remolques en jalisco, venta de remolques" />
...
<div class="product-detail">
  ...
  <div class="product-container">
    ...
    <div class="product-info">
      ...
      <a class="btn" href="${whatsappLink}" target="_blank">Cotizar por WhatsApp</a>
    </div>
  </div>
</div>
...
// Generate HTML file for each product
...
const baseUrl = 'https://mattonemattonediconcrette-eng.github.io/REMOLQUESLAPERLA';
